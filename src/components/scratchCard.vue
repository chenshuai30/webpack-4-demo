          ...
          <div class="flex-1 aia-newa-main-right">
            <div class="aia-newa-configform">
              ...
              <div v-show="activeStepName === 'reward'">
                <el-tabs v-model="accordionActiveName" @tab-remove="removePrizeTab">
                  <el-tab-pane :closable="index === 0 ? false : true" :label="'奖品' + (index+1) + '('+item.form.proportion+'%)'" v-for="item,index in stepTwoList" :key="item.id" :name="''+item.id">
                ...
                <div style="position: absolute;right: 30px;bottom: 30px;">
                  <span>奖品总概率：</span>
                  <el-input size="small" placeholder="请输入内容" :readonly="true" v-model="allProportion" style="width:130px">
    ...
    goNext() {
      ...
      switch (this.activeStepName) {
        ...
        case "reward": {
          ...
          // 老虎机至少有三个奖品
          if (this.tempDetail.htmlSrc === "templet/Tiger/index.html") {
            if (this.stepTwoList.length < 3) {
              this.$message.warning("至少有三个奖品");
              return;
            }
          }
